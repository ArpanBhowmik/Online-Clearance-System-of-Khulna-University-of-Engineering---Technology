<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HallStudent.aspx.cs" Inherits="WebApplication1.HallStudent" %>
...
<body style="background-color:; height: 470px; margin-right: 8px; width: 1352px;">
     ...
     <div id="main">
        <div id="topdiv">
         ...
         <div class="navbar">
             ...
             &nbsp;</div>
                  <marquee behavior="alternate" direction="left" >Welcome to Online Clearence System for Khulna University of Engineering & Technology!</marquee>

         <center class="auto-style20">     <asp:GridView ID="GridView1" runat="server" ShowHeaderWhenEmpty="false" EmptyDataText="No Records Found!"  CellPadding="4" ForeColor="Red" GridLines="None" Width="593px" CssClass="auto-style21" Height="131px">
